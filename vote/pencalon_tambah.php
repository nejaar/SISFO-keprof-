    ...
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=pencalon_tambah" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_pencalon" value="<?=$_POST['kode_pencalon']?>" autocomplete ="off"/>
            </div>
            <div class="form-group">
                <label>Nama Pencalon <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_pencalon" value="<?=$_POST['nama_pencalon']?>" autocomplete ="off"/>
            </div>
            <div class="form-group">
