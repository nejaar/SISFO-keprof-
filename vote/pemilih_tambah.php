    ...
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=pemilih_tambah">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="ktp" value="<?=$_POST['ktp']?>" autocomplete="off"/>
            </div>
            <div class="form-group">
                <label>Nama Pemilih <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_pemilih" value="<?=$_POST['nama_pemilih']?>" autocomplete="off"/>
            </div>
            <div class="form-group">
                <label>Alamat</label>
